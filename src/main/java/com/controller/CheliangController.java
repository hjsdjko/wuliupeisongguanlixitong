    ...
    */
    ...
    public R save(@RequestBody CheliangEntity cheliang, HttpServletRequest request){
        ...
        Wrapper<CheliangEntity> queryWrapper = new EntityWrapper<CheliangEntity>()
            ...
            .eq("cheliang_pailiang", cheliang.getCheliangPailiang())
            ;
...
//                            cheliangEntity.setYonghuId(Integer.valueOf(data.get(0)));   //司机 要改的
//                            cheliangEntity.setCheliangName(data.get(0));                    //车牌号 要改的
//                            cheliangEntity.setCheliangTypes(Integer.valueOf(data.get(0)));   //车辆类型 要改的
//                            cheliangEntity.setCheliangPailiang(data.get(0));                    //车辆排量 要改的
